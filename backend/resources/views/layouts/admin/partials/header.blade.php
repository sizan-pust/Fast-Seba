    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last ms-auto">
            <div class="nav-item d-none d-md-flex me-2">
                <a
                    href="{{ route('admin.module', ['module' => 'notifications']) }}"
                ...
                >
                    ...
                    @if ($adminUnreadNotifications > 0)
                        <span class="badge bg-red text-red-fg badge-notification badge-pill">
                            {{ min($adminUnreadNotifications, 99) }}
                        </span>
                    @endif
                </a>
            </div>
            ...
            <div class="nav-item dropdown">
                ...
                >
                    <span class="avatar avatar-sm fastsheba-avatar">
                        {{ str($adminUser?->name ?? 'A')
                            ->substr(0, 1)
                            ->upper() }}
                    </span>

...
class AdminCoreResourceController extends Controller
{
    ...
    {
        return view('admin.core.show', $this->resources->show($module, $id));
    }

    public function updateState(Request $request, string $module, int $id): RedirectResponse
    {
        $this->resources->updateState($module, $id, $request);

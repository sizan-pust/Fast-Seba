...
class OrderApiController extends Controller
{
    ...
    public function getTransactions(
        ...
        $query = OrderPaymentTransaction::query()
        ...
        return ApiResponseType::sendJsonResponse(
            ...
            [
                ...
                'total' => $items->total(),
                'data' => OrderPaymentResource::collection(
                    $items->items()
                )->resolve($request),
            ]
        );
    ...
    public function getTransaction(
        ...
        return ApiResponseType::sendJsonResponse(
            ...
            new OrderPaymentResource($transaction)
        );
    }

    public function getOrderDeliveryBoyLocation(
        Request $request,
        string $orderSlug
    ): JsonResponse {
        return ApiResponseType::sendJsonResponse(
            true,
            'Delivery location fetched.',
            $this->deliveryService->customerLocation(
                $request->user(),
                $orderSlug
            )
        );

...
class OrderItem extends Model
{
    ...
    {
        return [
            'price'=>'decimal:2','special_price'=>'decimal:2',
            'quantity'=>'integer','subtotal'=>'decimal:2',
            'tax_amount'=>'decimal:2','promo_discount'=>'decimal:2',
            'is_returnable'=>'boolean','returnable_until'=>'datetime',
    ...
    public function returnRequest(): HasOne { return $this->hasOne(OrderItemReturn::class); }
}

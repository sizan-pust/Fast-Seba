...
class Order extends Model
{
    ...
    protected $fillable = [
        'uuid','slug','user_id','address_id','delivery_zone_id','status',
        'payment_method','payment_status','delivery_type','is_rush_order',
        ...
        'estimated_delivery_time','paid_at','cancelled_at','metadata',
    ];
